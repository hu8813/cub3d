...
/*   Updated: 2023/09/27 20:06:24 by eelasam          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		i++;
// 	}
// 	if (err != 0 || g->f_color[0] == -1 || g->c_color[0] == -1
// 		|| g->f_color[1] == -1 || g->c_color[1] == -1 || g->f_color[2] == -1
// 		|| g->c_color[2] == -1 || !g->no_path || !g->so_path || !g->we_path
// 		|| !g->ea_path)
// 		return (1);
// 	i = 0;
...
// 1. Funktion zum Zuweisen von Texturen
...
// 2. Funktion zum Überprüfen von Farb- und Pfaddaten
...
// 3. Funktion zur Vorbereitung von Kartendaten
